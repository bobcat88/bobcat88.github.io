...
This project is indexed by GitNexus as **bobcat88.github.io** (410 symbols, 415 relationships, 0 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
