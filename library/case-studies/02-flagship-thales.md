# Étude de Cas : Industrialisation PMO & Risques — Thales ISR

## Meta
- **Date** : 2026-06-28
- **Mission** : Thales ISR (Brest)
- **Rôle** : PMO & Support Bid Management
- **Format** : Flagship (8 sections)
- **Tags** : #pmo, #finance, #defense, #vba, #risk
...
## 4. Approche
Mettre en place une approche d'**Earned Value Management (EVM)** standardisée et développer un script d'automatisation locale pour supprimer les saisies manuelles et fluidifier les revues de risques.

## 5. Actions
- **Automatisation VBA** : Développement d'un outil d'extraction et de synthèse automatique du registre des risques ROR (-92% de temps de traitement).
- **Templates standardisés** : Création de modèles de plannings types pré-remplis par gamme de produits dans MS Project et QDV, avec chemin critique pré-calculé.
- **Formation** : Animation d'ateliers méthodologiques pour les centres de compétences.
- **Audit RETEX** : Réalisation d'un audit Post-Mortem stratégique complet sur une offre majeure perdue pour la GBU.
...
- **VBA & Automation** : Gain d'efficience opérationnelle majeur.
- **RETEX Stratégique** : Analyse critique post-offre à destination du CODIR.
